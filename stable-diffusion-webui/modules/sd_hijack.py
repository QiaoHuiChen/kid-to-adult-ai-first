...
import ldm.modules.attention as attention_module

if hasattr(attention_module, 'BasicTransformerBlock'):
    if not hasattr(attention_module.BasicTransformerBlock, 'ATTENTION_MODES'):
        attention_module.BasicTransformerBlock.ATTENTION_MODES = {}
    
    # Now the assignment won't fail
    if hasattr(attention_module, 'CrossAttention'):
        attention_module.BasicTransformerBlock.ATTENTION_MODES["softmax-xformers"] = attention_module.CrossAttention
