...
def enable_midas_autodownload():
    ...
    try:
        from ldm.modules.midas.api import ISL_PATHS
    except ImportError:
        # Default ISL_PATHS if module doesn't exist
        ISL_PATHS = {
    ...
    from ldm.modules.midas.api import api

    # Create an api instance
    midas_api = api(model_type='dpt_hybrid')

    # Load the model
    midas.api.load_model_inner = midas_api.load_model
